...
const KEYWORD_CATEGORY_FAMILIES: KeywordCategoryFamily[] = [
  ...
  },
  {
    ...
    direction: "EXPENSE",
    categoryAliases: ["professional services", "legal", "legal fees", "accounting", "bookkeeping", "consulting"],
    tokenSignals: ["legal", "attorney", "lawyer", "accounting", "bookkeeping", "consulting", "consultant", "cpa"],
    phraseSignals: ["legal fee", "legal fees", "accounting service", "bookkeeping service", "consulting service", "professional service"],
    confidence: 82,
    reason: "Matched professional services keyword; Direction matched expense",
  },
  {
    id: "equipment",
    direction: "EXPENSE",
    categoryAliases: ["equipment", "tools", "small tools", "computer equipment", "furniture", "fixed assets"],
    tokenSignals: ["equipment", "tools", "computer", "laptop", "furniture", "printer", "hardware"],
    phraseSignals: ["computer equipment", "office equipment", "small tools", "equipment purchase", "furniture purchase"],
    confidence: 80,
    reason: "Matched equipment keyword; Direction matched expense",
  },
  {
    id: "inventory",
    direction: "EXPENSE",
    categoryAliases: ["inventory", "cost of goods sold", "cogs", "merchandise", "materials", "supplies inventory"],
    tokenSignals: ["inventory", "materials", "merchandise", "wholesale"],
    phraseSignals: ["inventory purchase", "raw materials", "cost of goods", "goods sold", "wholesale purchase"],
    confidence: 80,
    reason: "Matched inventory or materials keyword; Direction matched expense",
  },
  {
