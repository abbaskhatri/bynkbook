...
const KEYWORD_CATEGORY_FAMILIES: KeywordCategoryFamily[] = [
  ...
  },
  {
    id: "utilities",
    direction: "EXPENSE",
    categoryAliases: ["utilities", "utility", "electric", "gas utility", "water", "internet", "phone"],
    tokenSignals: ["utility", "utilities", "electric", "water", "internet", "comcast", "xfinity", "verizon", "att", "at&t", "spectrum"],
    phraseSignals: ["electric bill", "water bill", "utility bill", "internet bill", "phone bill"],
    confidence: 84,
  ...
  },
  {
    id: "office_supplies",
    direction: "EXPENSE",
    categoryAliases: ["office supplies", "supplies", "office", "printing"],
    tokenSignals: ["staples", "officedepot", "office", "printing"],
    phraseSignals: ["office depot", "office supply", "office supplies", "printing services"],
    confidence: 83,
