            ...
            <div className="relative flex min-h-[680px] w-full flex-col justify-between overflow-hidden rounded-[32px] border border-white/10 bg-white/6 p-8 shadow-[0_30px_80px_rgba(2,6,23,0.55)] backdrop-blur-xl">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-10 max-w-xl">
                  ...
                  <h1 className="mt-5 text-4xl font-semibold leading-tight text-white">
                    Confirm your email and finish setting up access.
                  </h1>
                  <p className="mt-4 max-w-lg text-base leading-7 text-slate-300">
                    Enter the verification code sent to your email to activate the account and continue into BynkBook.
                  </p>
                </div>
                ...
                <div className="mt-8 grid gap-3">
                  <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/6 px-4 py-4">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-white">Verification by email</div>
                      <div className="mt-1 text-sm text-slate-300">
                        The code is sent to the account email so activation stays tied to the correct identity.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/6 px-4 py-4">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-white">Secure activation</div>
                      <div className="mt-1 text-sm text-slate-300">
                        Confirmation completes the sign-up flow before sign-in and business setup continue.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/6 px-4 py-4">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-white">Ready for next step</div>
                      <div className="mt-1 text-sm text-slate-300">
                        Once confirmed, you move straight back into sign-in and then into business creation or the app.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative z-10 grid grid-cols-3 gap-3">
                <div className="rounded-2xl border border-white/10 bg-slate-950/30 px-4 py-4">
                  ...
                  <div className="mt-2 text-2xl font-semibold text-white">Received</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-slate-950/30 px-4 py-4">
                  <div className="text-xs uppercase tracking-[0.18em] text-slate-400">Account</div>
                  <div className="mt-2 text-2xl font-semibold text-white">Activated</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-slate-950/30 px-4 py-4">
              ...
              <CardContent className="p-0">
                ...
                <div className="px-6 py-6 sm:px-7">
                  <div className="space-y-4">
                    ...
                    >
                      <span>{busy ? "Confirming…" : "Confirm email"}</span>
