...
export default function ClosedPeriodsPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <PageHeader title="Closed Periods" subtitle="Account-scoped (MVP)" inlineAfterTitle={capsule} />
